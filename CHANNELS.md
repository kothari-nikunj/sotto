...
Reply *sending* is unaffected by all of this: replies are always one-tap deep links (`imessage:` /
`sms:` / `wa.me` / `mailto:`) you tap on your phone, so your contacts receive a real iMessage or SMS
no matter which channel delivers the brief to you.
