...
3. **Apply only what they choose.** Per their answers:
   ...
   - **"too noisy right now" / "quieter today"** — that's a *cadence* change, not a mute: route to
     `sotto-feedback` §C (`preferences.py snooze-nudges tomorrow | "+2h" | 15:00`,
     `unsnooze-nudges` for "back to normal"). Temporary and self-expiring; mutes are permanent.
