...
lines). The paths live here once instead: _shared/lib, _shared/scripts, _shared/knowledge, and
every skill's scripts/ directory. No two of those directories share a module name (verified across the pack),
