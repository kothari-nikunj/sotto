"""chatfmt.to_chat on a real brief — brief_markdown → the chat-deliverable text.
...
conversion is now deterministic — compose_brief runs the brief through to_chat and exposes the
...
import compose_brief as cb  # noqa: E402  (the brief_text end of the same contract)
