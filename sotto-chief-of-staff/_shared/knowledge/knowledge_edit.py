...
def run(argv: list) -> dict:
    ...
    ap.add_argument("--op", required=True,
                    choices=("correct", "archive", "add", "loop", "loop-add", "loop-deadline",
                             "merge", "merge-dismiss", "relation-add", "relation-remove"))
    ...
    ap.add_argument("--identifier", default="", help="their email/phone, if known (loop-add)")
