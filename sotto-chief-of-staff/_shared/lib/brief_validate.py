...
def _ledger_token(entry: dict) -> str:
    ...
    or — when the entry has none — the longest 5+ character word of its summary (a rare word is the
    cheapest evidence that THIS loop, not some other, got mentioned)."""
