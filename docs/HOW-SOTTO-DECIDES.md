...
- **One debt per counterpart** — an open loop is keyed by *who* it is with, and who is a machine
  ...
  WhatsApp's group JID), a person's by the person. Rename a group, or have the same ask written up
  differently tomorrow, and it is still the one open debt — never a second row.
- **What you owe expires quietly; what you're owed gets chased** — an open loop you owe drops off
  ...
  the contract — nudge her again, or let it go?"*
