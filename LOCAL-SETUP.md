...
creates six crons: `sotto-morning-brief` (6:30), `sotto-evening-brief` (17:30),
`sotto-relationship-pulse` (Mon 9:00), `sotto-proactive` (`*/15`, mostly-silent nudges — set
`SOTTO_PROACTIVE=0` to skip), `sotto-followup` (16:45 post-meeting follow-up — set
`SOTTO_FOLLOWUP=0` to skip), and `sotto-midday-digest` (12:30, an adaptive catch-up that runs the
